  ...
  function srcAppServiceProductRegistrationServiceTs(module, __webpack_exports__, __webpack_require__) {
    ...
    function () {
      ...
      _createClass(ProductRegistrationService, [{
        ...
        value: function getProductConfigurationById(product_id, order_id) {
          return this.http.get("".concat(this.API_URL, "/sorting/get-config/").concat(product_id, "/").concat(order_id));
        }
      }]);
