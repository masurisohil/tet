...
const routes = [
    ...
    {
        path: 'add',
        loadChildren: () => Promise.all(/*! import() | company-add-company-add-module */[__webpack_require__.e("default~add-bin-transfer-add-bin-transfer-module~add-configuration-add-configuration-module~add-orde~79bd05af"), __webpack_require__.e("company-add-company-add-module")]).then(__webpack_require__.bind(null, /*! ../company-add/company-add.module */ "./src/app/pages/company/company-add/company-add.module.ts")).then(m => m.CompanyAddModule),
