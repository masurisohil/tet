...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["pick-list-view-pick-list-view-module"], {
  ...
  /***/
  function node_modulesRawLoaderDistCjsJsSrcAppPagesOutboundPickListNewPickListViewPickListViewComponentHtml(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppPagesOutboundPickListNewPickListViewPickListViewComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    /*#__PURE__*/
    function () {
      function PickListViewComponent(activatedRoute, dataService, location, pickListNewService) {
        var _this = this;
      ...
      _createClass(PickListViewComponent, [{
        ...
        value: function ngOnInit() {
          ...
          this.pickListNewService.getPickListNewById(this.viewId).subscribe(function (response) {
            if (response.success) {
    ...
    PickListViewComponent = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
      ...
      "./node_modules/raw-loader/dist/cjs.js!./src/app/pages/outbound/pick-list-new/pick-list-view/pick-list-view.component.html")).default
  ...
  /***/
  function srcAppPagesOutboundPickListNewPickListViewPickListViewModuleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var _pick_list_view_component__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
      ...
      _createClass(PickListViewComponent, [{
        ...
        value: function getObject() {
          ...
          this.pickListService.getPickListGeneratedViewById(this.viewId).subscribe(function (response) {
            if (response.success) {
              _this4.orderDetails = response.data.order_detail;
              _this4.productList = response.data.product; // this.pagination = this.paginationService.getPager(response.data.pagination['total_page'], this.currentPage);
            } else {
              _this4.orderDetails = {};
              _this4.productList = [];
            }
