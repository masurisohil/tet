    ...
    function () {
      function AddProductComponent(router, activatedRoute, fb, productService) {
        ...
        this.addForm = this.fb.group({
          ...
          weight_unit: [null, _angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].compose([_angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].required])],
          weight: [null, _angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].compose([_angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].required])],
          total_volume: [0]
        });
      }
      ...
      _createClass(AddProductComponent, [{
        ...
        value: function getMasterData() {
          ...
          this.productService.getProductMasterData().subscribe(function (response) {
            if (response.success) {
              ...
              _this.weightUnitArray = response.data.weight_unit;
            }
          });
        }
      }, {
        ...
        value: function submitForm(formData) {
          ...
          if (formData.valid) {
            ...
            data.append('weight', formData.value.weight);
        ...
        key: "changeCategory",
        value: function changeCategory(data) {
          if (data && data.volume) {
            this.addForm.patchValue({
              width: data.volume.width,
              height: data.volume.height,
              depth: data.volume.depth,
