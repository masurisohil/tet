...
let AddPutAwayComponent = class AddPutAwayComponent {
    ...
    getProductByOrderId() {
        ...
        this.putawayService.getProductByOrderId(this.addForm.value.order_id).subscribe((response) => {
            if (response.success) {
                ...
                if (this.isEditing) {
                    this.skuListArray.map((obj) => {
                        if (obj.value == this.addForm.value.sku_no) {
                            this.tagListArray = obj.tag_list;
                        }
                    });
                }
            }
    ...
    setTaglist(data) {
        ...
        this.addForm.patchValue({ tag_id: null, qty: null });
        if (data) {
    ...
    calPutawayQuantity() {
        ...
        let putaway_qty = this.addForm.value.putaway_qty;
        let new_on_of_qty = Number(total / putaway_qty);
        // if (putaway_qty <= total) {
