...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  function srcAppMessagesTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var pageTitles = {
      ...
      packing_list: "Packing List | ".concat(APP_NAME),
      add_packing: "Add Packing | ".concat(APP_NAME),
      edit_packing: "Edit Packing | ".concat(APP_NAME),
      view_packing: "View Packing | ".concat(APP_NAME),
  ...
  function srcEnvironmentsEnvironmentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var environment = {
      ...
      APIEndpoint: 'https://c990946d11de.ngrok.io/api'
    };
    /*
